...
switch($_GET[act]){
  ...
  case "tambahsubmenu":
    ...
    echo "</select></td></tr>
          ...
          <tr><td class='left'>Urutan SubMenu</td><td class='left'> : <input style='width:40px;' type=text name='urutansubmenu' maxlength='2'></td></tr>
  ...
  case "editsubmenu":
	...
	echo "<tr><td class='left' width=100>Urutan Sub Menu</td>     <td> : <input type=text name='urutansubmenu' value='$r[posisi_sub]' maxlength='2'></td></tr>";
