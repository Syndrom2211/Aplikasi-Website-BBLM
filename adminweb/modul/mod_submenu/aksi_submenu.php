...
elseif ($module=='submenu' AND $act=='input'){
   mysql_query("INSERT INTO submenu(nama_sub,id_main,link_sub,id_submain,aktif,adminsubmenu,posisi_sub)
                 VALUES('$_POST[nama_sub]','$menu_utama','$_POST[link_sub]','$_POST[sub_menu]','$_POST[aktif]','$_POST[adminsubmenu]','$_POST[urutansubmenu]')");
   header('location:../../media.php?module='.$module);
}
...
elseif ($module=='submenu' AND $act=='update'){
    mysql_query("UPDATE submenu SET nama_sub    = '$_POST[nama_sub]',
                                    ...
                                    link_sub    = '$_POST[link_sub]',
												  ...
												  posisi_sub = '$_POST[urutansubmenu]'
