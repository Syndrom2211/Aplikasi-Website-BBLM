...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Menu Utama</h2>
		  ...
		  <td class='center'>urutan menu</td>
  ...
  case "tambahmenuutama":
    echo "<h2>Tambah Menu Utama</h2>
		  ...
		  <tr><td class='left'>Urutan Menu</td><td class='left'> : <input style='width:40px;' maxlength='2' type=text name='urutan'></td></tr>
  ...
  case "editmenuutama":
	...
	echo "<tr><td class='left'>Urutan Menu</td><td class='left'> : <input style='width:40px;' maxlength='2' type=text name='urutan' value='$r[urutan]'></</td></tr>";
