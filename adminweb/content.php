...
$tgl=tgl_indo(date("Y m d")); 	
  echo "<br /><p style='color:#fff;' align=center>Hai <b>$_SESSION[namauser]</b>, selamat datang di halaman Administrator. 
...
echo "  <div style=\"display: inline-block; width: 100%; margin-bottom: 15px; clear: both;\">
        ...
        <div style=\"background: #FFF; color: #547C96; border: 1px solid #62698a;; padding: 5px; font-size: 14px; font-weight: bold; border-radius:5px 5px 0 0; \">Komentar Terbaru</div>";          
...
echo "<div style=\"float: right; width: 49%;\">
        <div style=\"background: #FFF; color: #547C96; border: 1px solid #62698a; padding: 5px; font-size: 14px; font-weight: bold; border-radius:5px 5px 0 0; \">Hubungi Kami Terbaru</div>";          
  echo "<table class=\"list\">
            <thead>
            <tr>
             <td class=\"left\">Nama </td>
  ...
  echo "<table class='list'><thead>
		...
		<tr>
		  <td width=120 align=center><a href=media.php?module=user><img src=images/user.png border=none><br /><b>Manajemen Admin</b></a></td>
		  ...
		  <td width=120 align=center><a href=media.php?module=pelatihan><img src=images/aplikasi.png border=none><br /><b>Aplikasi Pelatihan</b></a></td>
    </tr>
		<tr>
		  ...
		  <td width=120 align=center><a href=media.php?module=redaksi><img src=images/redaksi.png border=none><br /><b>Redaksi</b></a></td>
    </tr>
    </table>";
  }
...
// Bagian Edit Redaksi
elseif ($_GET['module']=='redaksi'){
  if ($_SESSION['leveluser']=='admin'){
    include "modul/mod_redaksi/redaksi.php";
  }
}
