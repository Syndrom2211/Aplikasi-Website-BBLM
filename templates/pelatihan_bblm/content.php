<?php if($_GET['module'] == 'home') { ?>
    <div id="content">
        <div class="title">
		<?php echo add_widget('cari','sidebar'); ?>
...
// Bagian Form Aplikasi Pelatihan		
} else if($_GET['module']=='aplikasipelatihan'){
// Buat Query
$nama_lembaga      = trim(htmlentities($_POST["nama_lembaga"]));
$alamat_lembaga    = trim(htmlentities($_POST["alamat_lembaga"]));
$telepon_fax       = trim(htmlentities($_POST["telepon_fax"]));
$email_lembaga     = trim(htmlentities($_POST["email_lembaga"]));
$nama_peserta1     = trim(htmlentities($_POST["nama_peserta1"]));
$nama_peserta2     = trim(htmlentities($_POST["nama_peserta2"]));
$nama_peserta3     = trim(htmlentities($_POST["nama_peserta3"]));
$nama_peserta4     = trim(htmlentities($_POST["nama_peserta4"]));
$nama_peserta5     = trim(htmlentities($_POST["nama_peserta5"]));
$no_telp1 		   = trim(htmlentities($_POST["no_telp1"]));
$no_telp2          = trim(htmlentities($_POST["no_telp2"]));
$no_telp3          = trim(htmlentities($_POST["no_telp3"]));
$no_telp4          = trim(htmlentities($_POST["no_telp4"]));
$no_telp5          = trim(htmlentities($_POST["no_telp5"]));
$jenis_pendidikan1 = trim(htmlentities($_POST["jenis_pendidikan1"]));
$jenis_pendidikan2 = trim(htmlentities($_POST["jenis_pendidikan2"]));
$jenis_pendidikan3 = trim(htmlentities($_POST["jenis_pendidikan3"]));

// Bagian Email
// Keterangan : localhost gak punya identitas server yang dibutuhkan buat kirim-kirim email, jadi harus di upload dulu ke hostingan
$ke = "trainingbblm@yahoo.com";
$subject = "Permintaan Pelatihan Atas Nama Lembaga ".$_POST[nama_lembaga]."";
$pesan = '
<html>
<head>
<title>Data Permintaan Pelatihan</title>
</head>
<body>
<table border="0" cellpadding="2" cellspacing="2" style="background:#F0E68C; border: 10px double #777; width: 762px; height: 295px;">
<tbody>
<tr>
	<th colspan="2" style="border-bottom:1px dotted #000; font-size:14px; color:#777;"><h1>Data Permintaan Pelatihan</h1></th>
</tr>
<tr>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">
<p style="text-align: left;"><span style="font-family: times new roman,times; font-size: large;"><span style="font-family: terminal,monaco; font-size: medium;"><span style="font-family: book antiqua,palatino;">Nama Lembaga / Instansi</span></span><br /></span></p>
</td>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">&nbsp;: '.$_POST[nama_lembaga].'</td>
</tr>
<tr>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">
<p style="text-align: left;"><span style="font-family: times new roman,times; font-size: large;"><span style="font-family: book antiqua,palatino; font-size: medium;">Alamat Lembaga / Instansi</span><br /></span></p>
</td>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">&nbsp;: '.$_POST[alamat_lembaga].'</td>
</tr>
<tr>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">
<p style="text-align: left;"><span style="font-family: times new roman,times; font-size: large;"><span style="font-family: book antiqua,palatino; font-size: medium;">Telp / Fax Instansi</span><br /></span></p>
</td>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">&nbsp;: '.$_POST[telepon_fax].'</td>
</tr>
<tr>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">
<p style="text-align: left;"><span style="font-family: times new roman,times; font-size: large;"><span style="font-size: medium; font-family: book antiqua,palatino;">Alamat Email Lembaga</span><br /></span></p>
</td>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">&nbsp;: '.$_POST[email_lembaga].'</td>
</tr>
<tr style="height: 160px;">
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">
<p><span style="font-family: times new roman,times; font-size: large;"><span style="font-family: book antiqua,palatino; font-size: medium;">Nama Peserta</span><br /></span></p>
</td>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">1. '.$_POST[nama_peserta1].' / HP : '.$_POST[no_telp1].'<br /> 2. '.$_POST[nama_peserta2].' / HP : '.$_POST[no_telp2].'<br /> 3. '.$_POST[nama_peserta3].' / HP : '.$_POST[no_telp3].'<br /> 4. '.$_POST[nama_peserta4].' / HP : '.$_POST[no_telp4].'
<br /> 5. '.$_POST[nama_peserta5].' / HP : '.$_POST[no_telp5].'</td>
</tr>
<tr>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px; height: 100px;"><span style="font-family: book antiqua,palatino; font-size: medium;">Jenis Pelatihan yang di inginkan</span></td>
<td style="border-color: #ffffff; border-style: solid; border-width: 1px;">1. '.$_POST[jenis_pendidikan1].'<br />2. '.$_POST[jenis_pendidikan2].'<br />3. '.$_POST[jenis_pendidikan3].'</td>
</tr>
</tbody>
</table>
</body>
...
$keterangan = "MIME-Version: 1.0" . "\r\n";
$keterangan .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";

// More headers
$keterangan .= 'From:  '.$_POST[email_lembaga].'' . "\r\n";
			
// Bagian Proses
if(empty($_POST["nama_lembaga"]) || 
   empty($_POST["alamat_lembaga"]) || 
   empty($_POST["telepon_fax"]) || 
   empty($_POST["email_lembaga"]) || 
   empty($_POST["nama_peserta1"]) || 
   empty($_POST["nama_peserta2"]) || 
   empty($_POST["nama_peserta3"]) || 
   empty($_POST["nama_peserta4"]) || 
   empty($_POST["nama_peserta5"]) || 
   empty($_POST["no_telp1"]) || 
   empty($_POST["no_telp2"]) || 
   empty($_POST["no_telp3"]) || 
   empty($_POST["no_telp4"]) || 
   empty($_POST["no_telp5"]) || 
   empty($_POST["jenis_pendidikan1"]) || 
   empty($_POST["jenis_pendidikan2"]) || 
   empty($_POST["jenis_pendidikan3"])){
		echo "<script language='javascript'>alert('Data yang anda masukan belum lengkap!');</script>";
		echo '<meta http-equiv="refresh" content="0; url=statis-12-formaplikasipermintaanpelatihanteknis.html">';
}else if(!eregi("^[0-9]+$", $_POST["no_telp1"]) || 
		 !eregi("^[0-9]+$", $_POST["no_telp2"]) || 
		 !eregi("^[0-9]+$", $_POST["no_telp3"]) || 
		 !eregi("^[0-9]+$", $_POST["no_telp4"]) || 
		 !eregi("^[0-9]+$", $_POST["no_telp5"])){
		echo "<script language='javascript'>alert('Hanya berupa angka yang harus di masukan di no handphone!');</script>";
		echo '<meta http-equiv="refresh" content="0; url=statis-12-formaplikasipermintaanpelatihanteknis.html">';
}else if(!eregi("^[0-9]+$", $_POST["telepon_fax"])){
	echo "<script language='javascript'>alert('Hanya berupa angka yang harus di masukan di no telepon / fax!');</script>";
	echo '<meta http-equiv="refresh" content="0; url=statis-12-formaplikasipermintaanpelatihanteknis.html">';
}else{
	if(!empty($_POST['kode'])){
		if($_POST['kode'] == $_SESSION['captcha_session']){
			mysql_query("INSERT INTO pelatihan(nama_lembaga, alamat_lembaga, telepon_fax, email_lembaga, nama_peserta1, nama_peserta2, nama_peserta3, nama_peserta4, nama_peserta5, no_telp1, no_telp2, no_telp3, no_telp4, no_telp5, jenis_pendidikan1, jenis_pendidikan2, jenis_pendidikan3) values ('$_POST[nama_lembaga]','$_POST[alamat_lembaga]','$_POST[telepon_fax]','$_POST[email_lembaga]','$_POST[nama_peserta1]','$_POST[nama_peserta2]','$_POST[nama_peserta3]','$_POST[nama_peserta4]','$_POST[nama_peserta5]','$_POST[no_telp1]','$_POST[no_telp2]','$_POST[no_telp3]','$_POST[no_telp4]','$_POST[no_telp5]','$_POST[jenis_pendidikan1]','$_POST[jenis_pendidikan2]','$_POST[jenis_pendidikan3]')");
			mail($ke, $subject, $pesan, $keterangan);
			echo "<script language='javascript'>alert('Terima Kasih .. Data anda berhasil terkirim!');</script>";
			echo '<meta http-equiv="refresh" content="0; url=statis-12-formaplikasipermintaanpelatihanteknis.html">';
		}else{
			echo "<script language='javascript'>alert('Kode yang anda masukan tidak cocok!');</script>";
			echo '<meta http-equiv="refresh" content="0; url=statis-12-formaplikasipermintaanpelatihanteknis.html">';
		}
	}else{
			echo "<script language='javascript'>alert('Anda belum memasukan kode!');</script>";
			echo '<meta http-equiv="refresh" content="0; url=statis-12-formaplikasipermintaanpelatihanteknis.html">';	
	}
}
}
